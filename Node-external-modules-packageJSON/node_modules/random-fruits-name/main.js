const enFruits = require('random-fruits-name/langs/en.json')
const esFruits = require('random-fruits-name/langs/es.json')
const jaFruits = require('random-fruits-name/langs/ja.json')
const ptFruits = require('random-fruits-name/langs/pt.json')
const nlFruits = require('random-fruits-name/langs/nl.json')
const frFruits = require('random-fruits-name/langs/fr.json')
const deFruits = require('random-fruits-name/langs/de.json')
const csFruits = require('random-fruits-name/langs/cs.json')
const bnFruits = require('random-fruits-name/langs/bn.json')
